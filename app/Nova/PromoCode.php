...
class PromoCode extends Resource
{
     ...
     * @var string
     */
    public static $title = 'promo_name';
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ID::make()->sortable(),
            Text::make('Voucher Name','promo_name')->required(),
            Text::make('Voucher Code','promo_code')
                ->creationRules('required','unique:promo_codes,promo_code')
                ->updateRules('required','unique:promo_codes,promo_code,{{resourceId}}'),
