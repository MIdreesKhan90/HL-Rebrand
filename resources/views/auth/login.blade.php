            ...
            <div class="col-md-6">
                <div class="right-form">
                    ...
                    <div class="form-login-wrap">
                        <h5 class="text-center mb-30">Welcome back! Please log in to continue</h5>
...
<script>
            ...
            fetch(this.action, {
                ...
                .then(data => {
                    if (data.message === 'Magic link sent!') {
                        ...
                        // Handle any errors or unexpected messages here
                    }
                });
        });
    });
    ...
    function replaceFormWithMessage() {
        ...
        <p>To login, tap the link in the email we sent to ${document.querySelector('#email').value}</p>
    `;
    }
